...
/* The size of cose_key with ECC-P384. */
#define CCA_BYTE_SIZE_107   (107)
/* The size of cose_key with ECC-P521. */
#define CCA_BYTE_SIZE_143   (143)
#define CCA_BYTE_SIZE_550   (550)

#define VIRTCCA_SUCCESS     (0)
#define VIRTCCA_ERROR       (1)

#define CCA_CVM_CLAIM_CNT   (8)
/*
